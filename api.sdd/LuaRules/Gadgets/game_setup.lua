...
include("LuaRules/Gadgets/s11n/load_s11n.lua")
...
local function SpawnStartUnit(teamID)
	...
	if VFS.FileExist("LuaRules/Configs/campaign/spawn.lua") then
		-- SpringBoard exported s11n file
		start_units = VFS.Include("LuaRules/Configs/campaign/spawn.lua").unitS11N
		loadS11n(start_units, teamID)
	elseif (startUnit and startUnit ~= "") then
